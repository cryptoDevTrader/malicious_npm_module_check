...
MODULES='{
    ...
    "@pkgr/core": ["0.2.8"],
    "@zod-dto/core": ["0.5.1", "0.6.1", "0.7.1"],
    "@zod-dto/node": ["0.3.1", "0.4.1"],
    "angulartics2": ["14.1.2"],
    "ansi-regex": ["6.2.1"],
    "ansi-styles": ["6.2.2"],
    "async-chain-helper": ["3.4.1"],
    "atomic-finance": ["0.0.2"],
    "backslash": ["0.2.1"],
    "bb-builder": ["1.0.9"],
    "bignum-easy": ["1.0.4"],
    "chalk": ["5.6.1"],
    ...
    "css-vars-optimizer": ["4.1.1"],
    "debug": ["4.4.2"],
    "dev-tools-pro": ["1.0.0", "1.0.1"],
    "duckdb": ["1.3.3"],
    "electorn": ["1.0.0"],
    ...
    "grunt-purge-css": ["2.0.2"],
    "has-ansi": ["6.0.1"],
    "http-fetch-date": ["1.0.2"],
    "is": ["3.3.1", "5.0.0"],
    "is-arrayish": ["0.3.3"],
    "is-promise": ["2.2.2"],
    ...
    "ngx-toastr": ["19.0.2"],
    "ngx-trend": ["8.0.1"],
    "noblox.js-proxy": ["4.13.1"],
    "node-fetch-v2": ["2.6.7"],
    "node-ipc": ["9.2.2", "11.0.0"],
    "nodejs-encrypt-agent": ["1.1.28"],
    ...
    "slice-ansi": ["7.1.1"],
    "string-utility-extra": ["1.0.0", "1.0.1", "1.0.2", "1.1.0", "1.2.3"],
    "strip-ansi": ["7.1.1"],
